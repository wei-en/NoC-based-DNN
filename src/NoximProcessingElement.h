...
SC_MODULE(NoximProcessingElement)
{
    ...
    // modified PE with NI to access channel
    sc_port <sc_signal_in_if < NoximFlit >> flit_rx;	// The input channel
    sc_port <sc_signal_in_if < bool >> req_rx;	// The request associated with the input channel
    sc_port <sc_signal_out_if < bool >> ack_rx;	// The outgoing ack signal associated with the input channel

    sc_port <sc_signal_out_if < NoximFlit >> flit_tx;	// The output channel
    sc_port <sc_signal_out_if < bool >> req_tx;	// The request associated with the output channel
    sc_port <sc_signal_in_if < bool >> ack_tx;	// The outgoing ack signal associated with the output channel
		/***MODIFY BY HUI-SHUN***/
		sc_port <sc_signal_out_if <int >> free_slots;
		/***MODIFY BY HUI-SHUN***/
    sc_port <sc_signal_in_if < int >> free_slots_neighbor;
